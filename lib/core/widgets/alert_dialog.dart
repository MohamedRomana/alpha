...
/// بيرجّع القيمة اللي الديالوج اتقفل بيها (`context.pop(value)`)، أو `null`
/// لو اتقفل من بره — والنداءات اللي مش محتاجة نتيجة بتتجاهل الـ Future عادي.
Future<T?> customAlertDialog<T>({
