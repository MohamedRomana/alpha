...
// import '../routing/session_landing.dart';
...
//   /// ===============================
//   ///
//   /// كل نوع مستخدم ليه شاشة إشعارات مختلفة، وكل شاشة محتاجة الكيوبت بتاعها
//   /// متحقون — فبنفتحها بالراوت المسمّى عشان الراوتر يعمل الحقن. فتح الودجت
//   /// مباشرة بـ `MaterialPageRoute` كان هيرمي `ProviderNotFound`.
//   ///
//   /// الزائر أو اللي مسجّل خروج مالوش إشعارات، فمابنفتحش حاجة.
//   static void _openNotificationsScreen() {
//     final nav = navigatorKey.currentState;
//     if (nav == null) return;

//     if (CacheHelper.getToken().isEmpty || CacheHelper.getIsGuest()) return;

//     nav.pushNamed(
//       SessionLanding.isProvider(CacheHelper.getUserType())
